    ...
    return (
        <div className='flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400'>
            ...
            <div className='flex items-center gap-4'>
                    ...
                    token && userData
                        ...
                        <div className='flex items-center gap-2 cursor-pointer group relative' >
                            ...
                            <div className='absolute top-0 right-0 pt-14 text-base font-medium text-gray-600 hidden group-hover:block '>
                                <div className='min-w-48 bg-dark rounded flex flex-col gap-4 p-4'>
                        ...
                        : <button onClick={() => navigate('/login')} className='bg-primary text-dark px-8 py-3 rounded-full font-light hidden md:block'>Create Account</button>
                }
                ...
                <div className={` ${showMenu ? 'fixed w-full' : 'h-0 w-0'} md:hidden right-0 top-0 bottom-0 z-20 overflow-hidden  backdrop-blur-2xl transition-all`}>
